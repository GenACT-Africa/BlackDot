...
export function TalentCard({ talent, index }: { talent: Talent; index: number }) {
  ...
  return (
    <div className="group relative glass rounded-2xl overflow-hidden border border-white/8 hover:border-purple-500/30 transition-all duration-300 hover:shadow-glow-purple-sm h-full">
